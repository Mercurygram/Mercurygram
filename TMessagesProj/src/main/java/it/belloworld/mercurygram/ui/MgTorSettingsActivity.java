    ...
    private void promptInstallOrUpdatePlugin(Context context,
        ...
        switch (state) {
            ...
            case PLUGIN_SIGNATURE_MISMATCH:
                ...
                break;
            case PLUGIN_BIND_REFUSED:
                msgRes = R.string.MercurygramTorPluginBindRefused;
                break;
        ...
        if (state == it.belloworld.mercurygram.tor.MgTorClient.State.PLUGIN_BIND_REFUSED) {
            ...
            // that block the bind live.
            b.setNegativeButton(LocaleController.getString(R.string.Cancel), null);
            b.setPositiveButton(LocaleController.getString(R.string.MercurygramTorPluginOpenAppInfo),
                    (d, which) -> {
                        try {
        ...
        } else if (state == it.belloworld.mercurygram.tor.MgTorClient.State.PLUGIN_SIGNATURE_MISMATCH) {
