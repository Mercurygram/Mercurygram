...
//        });
    ...
    private void showAiButton(boolean show_) {
        final boolean show = show_ && parentFragment != null && !parentFragment.isSecretChat() && !UserConfig.getInstance(currentAccount).disableAiEditor;
...
//        }
    ...
    public boolean isMessageWebPageSearchEnabled() {
        ...
        // searchLinks() chokepoint in ChatActivity. ponytail: hard-off;
