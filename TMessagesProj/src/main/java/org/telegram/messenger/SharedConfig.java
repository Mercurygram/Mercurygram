...
public class SharedConfig {
    ...
    // line); a live change while obfs4 is the active transport needs the same
    // daemon relaunch as a mode switch, so it reuses applyTransportChange().
    ...
    // UserConfig.transcribeLang (a user may transcribe one account in English,
